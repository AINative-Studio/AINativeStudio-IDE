...
The purpose of this document is to explain how AINative Studio's codebase works. If you want build instructions instead, see [Contributing](https://github.com/AINative-Studio/AINativeStudio-IDE/blob/main/HOW_TO_CONTRIBUTE.md).
...
### Build process
If you want to know how our build pipeline works, see our build repo [here](https://github.com/AINative-Studio/ainative-studio-builder).
