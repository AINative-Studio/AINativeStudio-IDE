...
const VoidSelectionHelper = ({ rerenderKey }: VoidSelectionHelperProps) => {
  ...
  const dividerHTML = <div className="ainative-w-[0.5px] ainative-bg-void-border-3"></div>;
  ...
  return <div className=" ainative-pointer-events-auto ainative-select-none ainative-z-[1000] ainative-rounded-sm ainative-shadow-md ainative-flex ainative-flex-nowrap ainative-text-nowrap ainative-border ainative-border-void-border-3 ainative-bg-void-bg-2 ainative-transition-all ainative-duration-200 ">
