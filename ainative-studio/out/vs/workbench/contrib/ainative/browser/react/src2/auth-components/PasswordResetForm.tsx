  ...
  return (
    <div className="ainative-auth-form">
        ...
        <div className="ainative-error-message" role="alert" aria-live="polite">
            ...
            disabled={loading}
            className={errors.newPassword ? "ainative-error" : ""} />

					{errors.newPassword &&
          <span id="new-password-error" className="ainative-field-error" role="alert">
							{errors.newPassword}
						</span>
          }
					{!errors.newPassword &&
          ...
          <span id="confirm-new-password-error" className="ainative-field-error" role="alert">
							{errors.confirmPassword}
						</span>
          }
				</div>
