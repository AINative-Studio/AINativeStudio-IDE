...
export const OllamaSetupInstructions = ({ sayWeAutoDetect }: {sayWeAutoDetect?: boolean;}) => {
  return <div className="prose-p:void-my-0 prose-ol:void-list-decimal prose-p:void-py-0 prose-ol:void-my-0 prose-ol:void-py-0 prose-span:void-my-0 prose-span:void-py-0 void-text-void-fg-3 void-text-sm void-list-decimal void-select-text">
      ...
      data-tooltip-id='void-tooltip-ollama-settings'>
		...
		{sayWeAutoDetect && <div className=" void-pl-6"><ChatMarkdownRender string={`AINative Studio automatically detects locally running models and enables them.`} chatMessageLocation={undefined} /></div>}
	</div>;
};
              ...
              selectedSection === tab ? "void-bg-[#0e70c0]/80 void-text-white void-font-medium void-shadow-sm" : "void-bg-void-bg-2 hover:void-bg-void-bg-2/80 void-text-void-fg-1"} `}>
				...
				<main className="void-flex-1 void-p-6 void-select-none">
					...
					<div className="void-max-w-3xl">
						...
						<h1 className="void-text-2xl void-w-full">{`AINative Studio Settings`}</h1>

						<div className="void-w-full void-h-[1px] void-my-2" />

						{/* Account Section */}
						<ErrorBoundary>
							<div className="void-border void-border-void-border-2 void-bg-void-bg-1 void-py-4 void-px-4 void-rounded-md void-my-4">
								<h3 className="void-text-lg void-font-medium void-mb-3">AINative Cloud Account</h3>

								{auth.isAuthenticated ?
                <div className="void-flex void-items-center void-gap-4">
										<div className="void-flex void-items-center void-gap-3 void-flex-1">
											<div className="void-w-12 void-h-12 void-rounded-full void-bg-void-bg-2 void-flex void-items-center void-justify-center void-overflow-hidden">
												{auth.user?.name ?
                      <img
                      ...
                      <span className="void-text-void-fg-3 void-text-xl">👤</span>
                      }
											</div>
											<div className="void-flex void-flex-col">
												<div className="void-text-void-fg-1 void-font-medium">{auth.user?.name || auth.user?.email}</div>
												<div className="void-text-void-fg-3 void-text-sm">{auth.user?.email}</div>
											</div>
										</div>
										<VoidButtonBgDarken
                    className="void-px-4 void-py-2"
                    onClick={() => auth.logout()}>
                ...
                <div className="void-flex void-flex-col void-gap-2">
										<p className="void-text-void-fg-3 void-text-sm void-mb-2">
											Sign in to access AINative Cloud models
										</p>
										<VoidButtonBgDarken
                    className="void-px-4 void-py-2 void-w-fit void-bg-[#0e70c0] void-text-white hover:void-bg-[#1177cb]"
						...
						<div className="void-flex void-flex-col void-gap-12">
							...
							<div className={shouldShowTab('localProviders') ? `` : "void-hidden"}>
								<ErrorBoundary>
									...
									<h3 className={`void-text-void-fg-3 void-mb-2`}>{`AINative Studio can access any model that you host locally. We automatically detect your local models by default.`}</h3>
							...
							<div className={shouldShowTab('providers') ? `` : "void-hidden"}>
								<ErrorBoundary>
									...
									<h3 className={`void-text-void-fg-3 void-mb-2`}>{`AINative Studio can access models from Anthropic, OpenAI, OpenRouter, and more.`}</h3>
                            ...
                            return <div key={approvalType} className="void-flex void-items-center void-gap-x-2 void-my-2">
                              ...
                              onChange={(newVal) => voidSettingsService.setGlobalSetting('autoAcceptLLMChanges', newVal)} />
										...
										<div className="void-w-full">
											...
											<div className="void-text-sm void-text-void-fg-3 void-mt-1">{`Settings that control the visibility of AINative Studio suggestions in the code editor.`}</div>
							...
							<div className={`${shouldShowTab('general') ? `` : "void-hidden"} void-flex void-flex-col void-gap-12`}>
								...
								<div>
									<ErrorBoundary>
										...
										<h4 className="void-text-void-fg-3 void-mb-4">{`Transfer your editor settings into AINative Studio.`}</h4>
								...
								<div>
									...
									<h4 className="void-text-void-fg-3 void-mb-4">{`Transfer AINative Studio's settings and chats in and out of AINative Studio.`}</h4>
								...
								<div className="void-max-w-[600px]">
									...
									<h4 className={`void-text-void-fg-3 void-mb-4`}>Very basic anonymous usage tracking helps us keep AINative Studio running smoothly. You may opt out below. Regardless of this setting, AINative Studio never sees your code, messages, or API keys.</h4>
                          ...
                          onChange={(newVal) => {
                            ...
                            metricsService.capture(`Set metrics opt-out to ${newVal}`, {}); // this only fires if it's enabled, so it's fine to have here
								...
								<div className="void-max-w-[600px]">
									<h2 className={`void-text-3xl void-mb-2`}>Global Rules</h2>
...
Alternatively, place a \`.voidrules\` file in the root of your workspace.
                          ...
                          onChange={(newValue) => {
                            voidSettingsService.setGlobalSetting('disableSystemMessage', newValue);
								...
								<div className="void-max-w-[600px] void-mt-8">
									<h2 className={`void-text-3xl void-mb-2`}>Project Rules</h2>
									<h4 className={`void-text-void-fg-3 void-mb-4`}>
										<ChatMarkdownRender inPTag={true} string={`
