			...
			<div className="flex items-center justify-between mb-6">
				...
				<div className="flex items-center gap-3">
					...
					<div className="relative group">
						<button
							className="p-2 bg-ainative-bg-1 border border-ainative-border-2 rounded-md hover:bg-ainative-bg-2-hover transition-colors"
			...
			{loading && !refreshing ? (
				<div className="flex items-center justify-center py-24">
					<div className="text-center">
						...
						<p className="text-ainative-fg-3">Loading dashboard...</p>
					</div>
				</div>
			) : error ? (
				<div className="flex items-center justify-center py-24">
