...
export const AINativeLoginModal: React.FC<Props> = ({ onClose, onSuccess }) => {
  ...
  return (
    <div className="ainative-ainative-login-modal-overlay" onClick={onClose}>
			<div
        ref={modalRef}
        className="ainative-ainative-login-modal"
        onClick={(e) => e.stopPropagation()}
        role="dialog"
        aria-labelledby="modal-title"
        aria-modal="true">

				<div className="ainative-modal-header">
					<h2 id="modal-title">Sign In to AINative Cloud</h2>
					<button
            className="ainative-close-button"
            onClick={onClose}
            aria-label="Close"
            tabIndex={0}>
				...
				<div className="ainative-modal-body">
					{error &&
          <div className="ainative-error-message" role="alert">
							{error}
						</div>
          }
              ...
              type="submit"
              disabled={loading}
              className="ainative-submit-button">

							{loading ? 'Signing in...' : 'Sign In'}
						</button>
					</form>

					<div className="ainative-divider">or</div>

					<button
            className="ainative-github-signin-button"
            ...
            type="button">
					...
					<div className="ainative-signup-link">
