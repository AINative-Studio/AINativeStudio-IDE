    ...
    <div className="ainative-auth-form">
        ...
        <div className="ainative-error-message" role="alert" aria-live="polite">
            ...
            className={errors.email ? "ainative-error" : ""} />
					...
					{errors.email &&
          <span id="login-email-error" className="ainative-field-error" role="alert">
							{errors.email}
						</span>
          }
				</div>
            ...
            className={errors.password ? "ainative-error" : ""} />
					...
					{errors.password &&
          <span id="login-password-error" className="ainative-field-error" role="alert">
							{errors.password}
						</span>
          }
				</div>
				...
				{onSwitchToForgotPassword &&
        <div className="ainative-auth-form-link-container">
						<button
            type="button"
