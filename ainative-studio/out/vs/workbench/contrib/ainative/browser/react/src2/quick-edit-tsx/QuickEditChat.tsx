...
import { TextAreaFns, AINativeInputBox2 } from '../util/inputs.js';
import { QuickEditPropsType } from '../../../quickEditActions.js';
import { ButtonStop, ButtonSubmit, IconX, AINativeChatArea } from '../sidebar-tsx/SidebarChat.js';
import { VOID_CTRL_K_ACTION_ID } from '../../../actionIDs.js';
import { useRefState } from '../util/helpers.js';
import { isFeatureNameDisabled } from '../../../../../../../workbench/contrib/ainative/common/ainativeSettingsTypes.js';
...
export const QuickEditChat = ({
  ...
  const loadingIcon = <div
    className="codicon codicon-loading codicon-modifier-spin codicon-no-default-spin ainative-text-ainative-fg-3" />;
  ...
  return <div ref={sizerRef} style={{ maxWidth: 450 }} className={`ainative-py-2 ainative-w-full`}>
		<AINativeChatArea
      featureName='Ctrl+K'
      divRef={chatAreaRef}
      onSubmit={onSubmit}
