...
export const VoidInputBox2 = forwardRef<HTMLTextAreaElement, InputBox2Props>(function X({ initValue, placeholder, multiline, enableAtToMention, fnsRef, className, onKeyDown, onFocus, onBlur, onChangeText }, ref) {
  ...
  return <>
      ...
      className={`ainative-w-full ainative-resize-none ainative-max-h-[500px] ainative-overflow-y-auto ainative-text-void-fg-1 placeholder:ainative-text-void-fg-3 ${className}`}
      style={{
    ...
    <div
      ...
      className="ainative-z-[100] ainative-border-void-border-3 ainative-bg-void-bg-2-alt ainative-border ainative-rounded ainative-shadow-lg ainative-flex ainative-flex-col ainative-overflow-hidden"
      style={{
        position: strategy,
        top: y ?? 0,
        left: x ?? 0,
      ...
      onWheel={(e) => e.stopPropagation()}>
				...
				{/* Breadcrumbs Header */}
				{isBreadcrumbsShowing && <div className="ainative-px-2 ainative-py-1 ainative-text-void-fg-1 ainative-bg-void-bg-2-alt ainative-border-b ainative-border-void-border-3 ainative-sticky ainative-top-0 ainative-bg-void-bg-1 ainative-z-10 ainative-select-none ainative-pointer-events-none">
					{optionText ?
        ...
        <div className="ainative-opacity-50">Enter text to filter...</div>
				...
				<div className="ainative-max-h-[400px] ainative-w-full ainative-max-w-full ainative-overflow-y-auto ainative-overflow-x-auto">
					<div className="ainative-w-max ainative-min-w-full ainative-flex ainative-flex-col ainative-gap-0 ainative-text-nowrap ainative-flex-nowrap">
						{options.length === 0 ?
          <div className="ainative-text-void-fg-3 ainative-px-3 ainative-py-0.5">No results found</div> :
          options.map((o, oIdx) => {
            ...
            return (
              ...
              <div
                ...
                oIdx === optionIdx ? "ainative-bg-blue-500 ainative-text-white/80" : "ainative-bg-void-bg-2-alt ainative-text-void-fg-1"} `}
...
export const VoidSimpleInputBox = ({ value, onChangeValue, placeholder, className, disabled, passwordBlur, compact, ...inputProps
  ...
  return (
    <input
      ...
      placeholder={placeholder}
      disabled={disabled}
      className={`ainative-w-full ainative-resize-none ainative-bg-void-bg-1 ainative-text-void-fg-1 placeholder:ainative-text-void-fg-3 ainative-border ainative-border-void-border-2 focus:ainative-border-void-border-1 ${
...
export const VoidInputBox = ({ onChangeText, onCreateInstance, inputBoxRef, placeholder, isPasswordField, multiline
  ...
  return <WidgetComponent
    className=" ainative-bg-void-bg-1 void-force-child-placeholder-void-fg-1 "
    ...
    <div className={`ainative-inline-flex ainative-items-center ainative-flex-shrink-0 ${className}`}>
      ...
      style={{
        ...
        // paddingRight: thumbSizePx / 2
            ...
            size === 'sm+' ? "ainative-h-2" : "ainative-h-2.5"} ainative-bg-void-bg-2 ainative-rounded-full ainative-cursor-pointer`}
            ...
            onClick={handleTrackClick}>
              ...
              size === 'xs' ? "ainative-h-1" :
              size === 'sm' ? "ainative-h-1.5" :
              size === 'sm+' ? "ainative-h-2" : "ainative-h-2.5"} ainative-bg-void-fg-1 ainative-rounded-full`}
            ...
            size === 'sm+' ? "ainative-h-3.5 ainative-w-3.5" : "ainative-h-4 ainative-w-4"} ainative-bg-void-fg-1 ainative-rounded-full ainative-shadow-md ${

            disabled ? "ainative-cursor-not-allowed" : "ainative-cursor-grab active:ainative-cursor-grabbing"} ainative-border ainative-border-void-fg-1`}
...
export const VoidCustomDropdownBox = <T extends NonNullable<any>,>({
  ...
  return (
    <div className={`ainative-inline-block ainative-relative ${className}`}>
      ...
      <div
        ref={refs.setFloating}
        className="ainative-z-[100] ainative-bg-void-bg-1 ainative-border-void-border-3 ainative-border ainative-rounded ainative-shadow-lg"
        style={{
          position: strategy,
          top: y ?? 0,
          left: x ?? 0,
...
export const _VoidSelectBox = <T,>({ onChangeSelection, onCreateInstance, selectBoxRef, options, className
  ...
  return <WidgetComponent
    className={` select-child-restyle [&_select]:!void-text-void-fg-3 [&_select]:!void-text-xs !ainative-text-void-fg-3 ${
...
export const BlockCode = ({ initValue, language, maxHeight, showScrollbars }: BlockCodeProps) => {
  ...
  return <div ref={divRef} className="ainative-relative ainative-z-0 ainative-px-2 ainative-py-1 ainative-bg-void-bg-3">
		<WidgetComponent
...
const SingleDiffEditor = ({ block, lang }: {block: ExtractedSearchReplaceBlock;lang: string | undefined;}) => {
  ...
  return (
    <div className="ainative-w-full ainative-bg-void-bg-3 bg-editor-style-override" ref={divRef} />);
...
export const VoidDiffEditor = ({ uri, searchReplaceBlocks, language }: {uri?: any;searchReplaceBlocks: string;language?: string;}) => {
  ...
  if (blocks.length === 0) {
    return <div className="ainative-w-full ainative-p-4 ainative-text-void-fg-4 ainative-text-sm">No changes found</div>;
  }
  ...
  return (
    <div className="ainative-w-full ainative-flex ainative-flex-col ainative-gap-2">
      ...
      <div key={index} className="ainative-w-full">
					{blocks.length > 1 &&
        <div className="ainative-text-void-fg-4 ainative-text-xs ainative-mb-1 ainative-px-1">
