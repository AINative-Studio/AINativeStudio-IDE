...
export const AINativeOnboarding = () => {
  ...
  return (
    <div className={`ainative-scope ${isDark ? "ainative-dark" : ""}`}>
			<div
        className={` ainative-bg-ainative-bg-3 ainative-fixed ainative-top-0 ainative-right-0 ainative-bottom-0 ainative-left-0 ainative-width-full ainative-z-[99999] ainative-transition-all ainative-duration-1000 ${
...
const AddProvidersPage = ({ pageIndex, setPageIndex }: {pageIndex: number;setPageIndex: (index: number) => void;}) => {
  ...
  return <div className="ainative-flex ainative-flex-col md:ainative-flex-row ainative-w-full ainative-h-[80vh] ainative-gap-6 ainative-max-w-[900px] ainative-mx-auto ainative-relative">
		{/* Left Column */}
		<div className="md:ainative-w-1/4 ainative-w-full ainative-flex ainative-flex-col ainative-gap-6 ainative-p-6 ainative-border-none ainative-border-ainative-border-2 ainative-h-full ainative-overflow-y-auto">
			{/* Tab Selector */}
			<div className="ainative-flex md:ainative-flex-col ainative-gap-2">
				{[...tabNames, 'Cloud/Other'].map((tab) =>
        <button
          key={tab}
          className={`ainative-py-2 ainative-px-4 ainative-rounded-md ainative-text-left ${currentTab === tab ? "ainative-bg-[#0e70c0]/80 ainative-text-white ainative-font-medium ainative-shadow-sm" : "ainative-bg-ainative-bg-2 hover:ainative-bg-ainative-bg-2/80 ainative-text-ainative-fg-1"} ainative-transition-all ainative-duration-200`}
		...
		<div className="ainative-flex-1 ainative-flex ainative-flex-col ainative-items-center ainative-justify-start ainative-p-6 ainative-h-full ainative-overflow-y-auto">
			...
			<div className="ainative-w-full ainative-max-w-xl ainative-mt-4 ainative-mb-10">
				...
				<div className="ainative-text-sm ainative-opacity-80 ainative-text-ainative-fg-3 ainative-my-4 ainative-w-full">{descriptionOfTab[currentTab]}</div>
			</div>
      ...
      <div className="ainative-w-full ainative-max-w-xl ainative-mt-8 ainative-bg-ainative-bg-2/50 ainative-rounded-lg ainative-p-6 ainative-border ainative-border-ainative-border-4">
					...
					{currentTab === 'Local' &&
        <div className="ainative-text-sm ainative-opacity-80 ainative-text-ainative-fg-3 ainative-my-4 ainative-w-full">Local models should be detected automatically. You can add custom models below.</div>
        }
...
const OllamaDownloadOrRemoveModelButton = ({ modelName, isModelInstalled, sizeGb }: {modelName: string;isModelInstalled: boolean;sizeGb: number | false | 'not-known';}) => {
  ...
  return <a
    ...
    className="ainative-flex ainative-items-center ainative-justify-center ainative-text-ainative-fg-2 hover:ainative-text-ainative-fg-1">
    ...
    2: <OnboardingPageShell
      ...
      <div>
					...
					<div className="ainative-mt-8 ainative-text-center ainative-flex ainative-flex-col ainative-items-center ainative-gap-4 ainative-w-full ainative-max-w-md ainative-mx-auto">
						<h4 className="ainative-text-ainative-fg-3 ainative-mb-4">Transfer your settings from an existing editor?</h4>
