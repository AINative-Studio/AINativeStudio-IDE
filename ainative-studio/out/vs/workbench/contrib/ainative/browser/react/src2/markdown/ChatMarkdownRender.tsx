...
const Codespan = ({ text, className, onClick, tooltip }: {text: string;className?: string;onClick?: () => void;tooltip?: string;}) => {
  ...
  return <code
    className={`ainative-font-mono ainative-font-medium ainative-rounded-sm ainative-bg-void-bg-1 ainative-px-1 ${className}`}
    onClick={onClick}
    {...tooltip ? {
  ...
  if (t.type === 'link') {
    return (
      <a
        ...
        className="ainative-underline ainative-cursor-pointer hover:ainative-brightness-90 ainative-transition-all ainative-duration-200 ainative-text-void-fg-2">
