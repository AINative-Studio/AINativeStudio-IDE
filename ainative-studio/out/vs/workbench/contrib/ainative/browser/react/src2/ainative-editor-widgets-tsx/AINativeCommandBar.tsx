  ...
  if (currFileIdx === null) {
    return (
      <div className="ainative-pointer-events-auto">
				<div className="ainative-flex ainative-bg-ainative-bg-2 ainative-shadow-md ainative-border ainative-border-ainative-border-2 [&>*:first-child]:ainative-pl-3 [&>*:last-child]:ainative-pr-3 [&>*]:ainative-border-r [&>*]:ainative-border-ainative-border-2 [&>*:last-child]:ainative-border-r-0">
  ...
  return (
    <div className="ainative-pointer-events-auto">
      ...
      <div className="ainative-flex ainative-justify-end ainative-mb-1">
					<div className="ainative-inline-flex ainative-bg-ainative-bg-2 ainative-rounded ainative-shadow-md ainative-border ainative-border-ainative-border-2 ainative-overflow-hidden">
						<div className="ainative-flex ainative-items-center [&>*]:ainative-border-r [&>*]:ainative-border-ainative-border-2 [&>*:last-child]:ainative-border-r-0">
			...
			<div className="ainative-flex ainative-items-center ainative-bg-ainative-bg-2 ainative-rounded ainative-shadow-md ainative-border ainative-border-ainative-border-2 [&>*:first-child]:ainative-pl-3 [&>*:last-child]:ainative-pr-3 [&>*]:ainative-px-3 [&>*]:ainative-border-r [&>*]:ainative-border-ainative-border-2 [&>*:last-child]:ainative-border-r-0">
