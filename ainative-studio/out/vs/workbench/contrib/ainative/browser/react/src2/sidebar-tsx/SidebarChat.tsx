...
const ReasoningOptionSlider = ({ featureName }: {featureName: FeatureName;}) => {
  ...
  if (canTurnOffReasoning && !reasoningBudgetSlider) {// if it's just a on/off toggle without a power slider
    return <div className="ainative-flex ainative-items-center ainative-gap-x-2">
			<span className="ainative-text-void-fg-3 ainative-text-xs ainative-pointer-events-none ainative-inline-block ainative-w-10 ainative-pr-1">Thinking</span>
			<VoidSwitch
        size='xxs'
    ...
    return <div className="ainative-flex ainative-items-center ainative-gap-x-2">
        ...
        onChange={(newVal) => {
          ...
          voidSettingsService.setOptionsOfModelSelection(featureName, modelSelection.providerName, modelSelection.modelName, { reasoningEnabled: !isOff, reasoningBudget: newVal });
			...
			<span className="ainative-text-void-fg-3 ainative-text-xs ainative-pointer-events-none">{isReasoningEnabled ? `${value} tokens` : 'Thinking disabled'}</span>
		</div>;
  }
    ...
    return <div className="ainative-flex ainative-items-center ainative-gap-x-2">
        ...
        onChange={(newVal) => {
          ...
          voidSettingsService.setOptionsOfModelSelection(featureName, modelSelection.providerName, modelSelection.modelName, { reasoningEnabled: !isOff, reasoningEffort: values[newVal] ?? undefined });
			...
			<span className="ainative-text-void-fg-3 ainative-text-xs ainative-pointer-events-none">{isReasoningEnabled ? `${currentEffortCapitalized}` : 'Thinking disabled'}</span>
		</div>;
  }
...
export const VoidChatArea: React.FC<VoidChatAreaProps> = ({
  ...
  return (
    <div
      ref={divRef}
      className={` ainative-gap-x-1 ainative-flex ainative-flex-col ainative-p-2 ainative-relative ainative-input ainative-text-left ainative-shrink-0 ainative-rounded-md ainative-bg-void-bg-1 ainative-transition-all ainative-duration-200 ainative-border ainative-border-void-border-3 focus-within:ainative-border-void-border-1 hover:ainative-border-void-border-1 ainative-max-h-[80vh] ainative-overflow-y-auto ${
      ...
      <SelectedFiles
        ...
        <div className="ainative-absolute -ainative-top-1 -ainative-right-1 ainative-cursor-pointer ainative-z-1">
						<IconX
            size={12}
            className="ainative-stroke-[2] ainative-opacity-80 ainative-text-void-fg-3 hover:ainative-brightness-95"
            onClick={onClose} />
        ...
        <div className="ainative-flex ainative-flex-col ainative-gap-y-1">
						...
						<div className="ainative-flex ainative-items-center ainative-flex-wrap ainative-gap-x-2 ainative-gap-y-1 ainative-text-nowrap ">
							{featureName === 'Chat' && <ChatModeDropdown className="ainative-text-xs ainative-text-void-fg-3 ainative-bg-void-bg-1 ainative-border ainative-border-void-border-2 ainative-rounded ainative-py-0.5 ainative-px-1" />}
							<ModelDropdown featureName={featureName} className="ainative-text-xs ainative-text-void-fg-3 ainative-bg-void-bg-1 ainative-rounded" />
						</div>
					</div>
        }
    ...
    <div className="ainative-flex ainative-items-center ainative-flex-wrap ainative-text-left ainative-relative ainative-gap-x-0.5 ainative-gap-y-1 ainative-pb-0.5">
        ...
        className={`ainative-flex ainative-flex-col ainative-space-y-[1px]`}>
          ...
          data-tooltip-delay-show={3000}>
              ...
              isThisSelectionProspective ? "ainative-bg-void-bg-1 ainative-text-void-fg-3 ainative-opacity-80" : "ainative-bg-void-bg-1 hover:ainative-brightness-95 ainative-text-void-fg-1"} ${
              isThisSelectionProspective ? "ainative-border-void-border-2" : "ainative-border-void-border-1"} hover:ainative-border-void-border-1 ainative-transition-all ainative-duration-150 `}
              ...
              <span className={`ainative-text-[8px] ainative-'void-opacity-60 ainative-text-void-fg-4`}>
									{`(Current File)`}
								</span> :
              null
              }
...
const ToolHeaderWrapper = ({
  ...
  const desc1HTML = <span
    className={`ainative-text-void-fg-4 ainative-text-xs ainative-italic ainative-truncate ainative-ml-2 ${
  ...
  return <div className="">
		<div className={`ainative-w-full ainative-border ainative-border-void-border-3 ainative-rounded ainative-px-2 ainative-py-1 ainative-bg-void-bg-3 ainative-overflow-hidden ${className}`}>
			{/* header */}
          ...
          className="ainative-ml-1 ainative-flex ainative-items-center ainative-overflow-hidden">
            ...
            onClick={() => {
              ...
              if (onClick) {onClick();}
                ...
                className={` ainative-text-void-fg-3 ainative-mr-0.5 ainative-h-4 ainative-w-4 ainative-flex-shrink-0 ainative-transition-transform ainative-duration-100 ainative-ease-[cubic-bezier(0.4,0,0.2,1)] ${

                isExpanded ? "ainative-rotate-90" : ""} `} />

              }
							<span className="ainative-text-void-fg-3 ainative-flex-shrink-0">{title}</span>
					...
					<div className="ainative-flex ainative-items-center ainative-gap-x-2 ainative-flex-shrink-0">
						...
						{info && <CircleEllipsis
              className="ainative-ml-2 ainative-text-void-fg-4 ainative-opacity-60 ainative-flex-shrink-0"
              size={14}
              data-tooltip-id='ainative-tooltip'
              ...
              className="ainative-text-void-warning ainative-opacity-90 ainative-flex-shrink-0"
              size={14}
              data-tooltip-id='ainative-tooltip'
              ...
              data-tooltip-place='top' />
						...
						{isRejected && <Ban
              className="ainative-text-void-fg-4 ainative-opacity-90 ainative-flex-shrink-0"
              size={14}
              data-tooltip-id='ainative-tooltip'
              data-tooltip-content={'Canceled'}
              data-tooltip-place='top' />
            }
						{desc2 && <span className="ainative-text-void-fg-4 ainative-text-xs" onClick={desc2OnClick}>
							{desc2}
						</span>}
						{numResults !== undefined &&
            <span className="ainative-text-void-fg-4 ainative-text-xs ainative-ml-auto ainative-mr-1">
			...
			{/* children */}
			{<div
        className={`ainative-overflow-hidden ainative-transition-all ainative-duration-200 ainative-ease-in-out ${isExpanded ? "ainative-opacity-100 ainative-py-1" : "ainative-max-h-0 ainative-opacity-0"} ainative-text-void-fg-4 ainative-rounded-sm ainative-overflow-x-auto `}
...
const EditTool = ({ toolMessage, threadId, messageIdx, content }: Parameters<ResultWrapper<'edit_file' | 'rewrite_file'>>[0] & {content: string;}) => {
  ...
  if (toolMessage.type === 'running_now' || toolMessage.type === 'tool_request') {
    componentParams.children = <ToolChildrenWrapper className="ainative-bg-void-bg-3">
			<EditToolChildren
        uri={params.uri}
        code={content}
        type={editToolType} />
    ...
    <div>
          ...
          onClick={() => {
            if (isDropdown) {setIsOpen((v) => !v);}
					...
					{isDropdown &&
          <ChevronRight
            className={`ainative-text-void-fg-3 ainative-mr-0.5 ainative-h-4 ainative-w-4 ainative-flex-shrink-0 ainative-transition-transform ainative-duration-100 ainative-ease-[cubic-bezier(0.4,0,0.2,1)] ${isOpen ? "ainative-rotate-90" : ""}`} />

          }
					<div className="ainative-flex ainative-items-center ainative-w-full ainative-overflow-hidden">
						<span className="ainative-text-void-fg-3">{title}</span>
					</div>
				</div>
				{/* children */}
				{<div
          className={`ainative-overflow-hidden ainative-transition-all ainative-duration-200 ainative-ease-in-out ${isOpen ? "ainative-opacity-100" : "ainative-max-h-0 ainative-opacity-0"} ainative-text-void-fg-4`}>
...
const UserMessageComponent = ({ chatMessage, messageIdx, isCheckpointGhost, currCheckpointIdx, _scrollToBottom }: {chatMessage: ChatMessage & {role: 'user';};messageIdx: number;currCheckpointIdx: number | undefined;isCheckpointGhost: boolean;_scrollToBottom: (() => void) | null;}) => {
  ...
  onMouseLeave={() => setIsHovered(false)}>
    ...
    mode === 'edit' ? "" :
    mode === 'display' ? "ainative-p-2 ainative-flex ainative-flex-col ainative-bg-void-bg-1 ainative-text-void-fg-1 ainative-overflow-x-auto ainative-cursor-pointer" : ""} `}
    ...
    >
			<EditSymbol
        size={18}
        className={` ainative-cursor-pointer ainative-p-[2px] ainative-bg-void-bg-1 ainative-border ainative-border-void-border-1 ainative-rounded-md ainative-transition-opacity ainative-duration-200 ainative-ease-in-out ${
...
const SmallProseWrapper = ({ children }: {children: React.ReactNode;}) => {
  return <div className=" ainative-text-void-fg-4 ainative-prose ainative-prose-sm ainative-break-words ainative-max-w-none ainative-leading-snug ainative-text-[13px] [&>:first-child]:!ainative-mt-0 [&>:last-child]:!ainative-mb-0 prose-h1:ainative-text-[14px] prose-h1:ainative-my-4 prose-h2:ainative-text-[13px] prose-h2:ainative-my-4 prose-h3:ainative-text-[13px] prose-h3:ainative-my-3 prose-h4:ainative-text-[13px] prose-h4:ainative-my-2 prose-p:ainative-my-2 prose-p:ainative-leading-snug prose-hr:ainative-my-2 prose-ul:ainative-my-2 prose-ul:ainative-pl-4 prose-ul:ainative-list-outside prose-ul:ainative-list-disc prose-ul:ainative-leading-snug prose-ol:ainative-my-2 prose-ol:ainative-pl-4 prose-ol:ainative-list-outside prose-ol:ainative-list-decimal prose-ol:ainative-leading-snug marker:ainative-text-inherit prose-blockquote:ainative-pl-2 prose-blockquote:ainative-my-2 prose-code:ainative-text-void-fg-3 prose-code:ainative-text-[12px] prose-code:before:ainative-content-none prose-code:after:ainative-content-none prose-pre:ainative-text-[12px] prose-pre:ainative-p-2 prose-pre:ainative-my-2 prose-table:ainative-text-[13px] ">
...
const ProseWrapper = ({ children }: {children: React.ReactNode;}) => {
  return <div className=" ainative-text-void-fg-2 ainative-prose ainative-prose-sm ainative-break-words prose-p:ainative-block prose-hr:ainative-my-4 prose-pre:ainative-my-2 marker:ainative-text-inherit prose-ol:ainative-list-outside prose-ol:ainative-list-decimal prose-ul:ainative-list-outside prose-ul:ainative-list-disc prose-li:ainative-my-0 prose-code:before:ainative-content-none prose-code:after:ainative-content-none prose-headings:ainative-prose-sm prose-headings:ainative-font-bold prose-p:ainative-leading-normal prose-ol:ainative-leading-normal prose-ul:ainative-leading-normal ainative-max-w-none ">
...
export const ListableToolItem = ({ name, onClick, isSmall, className, showDot }: {name: React.ReactNode;onClick?: () => void;isSmall?: boolean;className?: string;showDot?: boolean;}) => {
  return <div
    ...
    onClick={onClick}>
		...
		<div className={`${isSmall ? "ainative-italic ainative-text-void-fg-4 ainative-flex ainative-items-center" : ""}`}>{name}</div>
	</div>;
};
...
const LintErrorChildren = ({ lintErrors }: {lintErrors: LintErrorItem[];}) => {
  return <div className="ainative-text-xs ainative-text-void-fg-4 ainative-opacity-80 ainative-border-l-2 ainative-border-void-warning ainative-px-2 ainative-py-0.5 ainative-flex ainative-flex-col ainative-gap-0.5 ainative-overflow-x-auto ainative-whitespace-nowrap">
  ...
  return (
    <div className="ainative-w-full ainative-px-2 ainative-mt-0.5">
        ...
        style={{ background: 'none' }}>
				...
				<ChevronRight
          className={`ainative-mr-1 ainative-h-3 ainative-w-3 ainative-flex-shrink-0 ainative-transition-transform ainative-duration-100 ainative-text-void-fg-4 group-hover:ainative-text-void-fg-3 ${isOpen ? "ainative-rotate-90" : ""}`} />

				<span className="ainative-font-medium ainative-text-void-fg-4 group-hover:ainative-text-void-fg-3 ainative-text-xs">{title}</span>
			</div>
			<div
        className={`ainative-overflow-hidden ainative-transition-all ainative-duration-200 ainative-ease-in-out ${isOpen ? "ainative-opacity-100" : "ainative-max-h-0 ainative-opacity-0"} ainative-text-xs ainative-pl-4`}>
				...
				<div className="ainative-overflow-x-auto ainative-text-void-fg-4 ainative-opacity-90 ainative-border-l-2 ainative-border-void-warning ainative-px-2 ainative-py-0.5">
					{children}
				</div>
			</div>
		</div>);
...
const InvalidTool = ({ toolName, message, mcpServerName }: {toolName: ToolName;message: string;mcpServerName: string | undefined;}) => {
  ...
  componentParams.children = <ToolChildrenWrapper>
		<CodeChildren className="ainative-bg-void-bg-3">
			{message}
		</CodeChildren>
	</ToolChildrenWrapper>;
  return <ToolHeaderWrapper {...componentParams} />;
...
const Checkpoint = ({ message, threadId, messageIdx, isCheckpointGhost, threadIsRunning }: {message: CheckpointEntry;threadId: string;messageIdx: number;isCheckpointGhost: boolean;threadIsRunning: boolean;}) => {
  ...
  return <div
    className={`ainative-flex ainative-items-center ainative-justify-center ainative-px-2 `}>
		...
		<div
      className={` ainative-text-xs ainative-text-void-fg-3 ainative-select-none ${
...
const CommandBarInChat = () => {
  ...
  const fileDetailsContent = <div className="ainative-px-2 ainative-gap-1 ainative-w-full ainative-overflow-y-auto">
      ...
      const fileNameHTML = <div
        className="ainative-flex ainative-items-center ainative-gap-1.5 ainative-text-void-fg-3 hover:ainative-brightness-125 ainative-transition-all ainative-duration-200 ainative-cursor-pointer"
        onClick={() => voidOpenFileFn(uri, accessor)}>

				{/* <FileIcon size={14} className="text-void-fg-3" /> */}
				<span className="ainative-text-void-fg-3">{basename}</span>
			</div>;
      ...
      const detailsContent = <div className="ainative-flex ainative-px-4">
				<span className="ainative-text-void-fg-3 ainative-opacity-80">{numDiffs} diff{numDiffs !== 1 ? 's' : ''}</span>
			</div>;
  ...
  return (
    <>
			...
			<div className="ainative-px-2">
				<div
          className={` ainative-select-none ainative-flex ainative-w-full ainative-rounded-t-lg ainative-bg-void-bg-3 ainative-text-void-fg-3 ainative-text-xs ainative-text-nowrap ainative-overflow-hidden ainative-transition-all ainative-duration-200 ainative-ease-in-out ${
          ...
          isFileDetailsOpened ? "ainative-max-h-24" : "ainative-max-h-0"} `}>
			...
			{/* main content */}
			<div
        className={` ainative-select-none ainative-flex ainative-w-full ainative-rounded-t-lg ainative-bg-void-bg-3 ainative-text-void-fg-3 ainative-text-xs ainative-text-nowrap ainative-border-t ainative-border-l ainative-border-r ainative-border-zinc-300/10 ainative-px-2 ainative-py-1 ainative-justify-between `}>
...
export const SidebarChat = () => {
  ...
  const initiallySuggestedPromptsHTML = <div className="ainative-flex ainative-flex-col ainative-gap-2 ainative-w-full ainative-text-nowrap ainative-text-void-fg-3 ainative-select-none">
		{[
  ...
  const landingPageContent = <div
    ...
    <ErrorBoundary>
				<div className="ainative-pt-8 ainative-mb-2 ainative-text-void-fg-3 ainative-text-root ainative-select-none ainative-pointer-events-none">Previous Threads</div>
				<PastThreadsList />
			</ErrorBoundary> :

    <ErrorBoundary>
				<div className="ainative-pt-8 ainative-mb-2 ainative-text-void-fg-3 ainative-text-root ainative-select-none ainative-pointer-events-none">Suggestions</div>
