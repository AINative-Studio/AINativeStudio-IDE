...
export const SidebarChat = () => {
  ...
  const welcomeMessage = <div className="void-pt-8 void-pb-4 void-text-center">
		<div className="void-text-2xl void-font-semibold void-text-void-fg-2 void-mb-2">Hi I'm Cody</div>
		<div className="void-text-void-fg-3">How can I help you?</div>
	</div>;
  ...
  return (
    ...
    >
			<div className="void-relative void-w-full void-h-full">
				{/* Main content */}
				<div className={`void-w-full void-h-full void-transition-all void-duration-300 ${showPromptHistory ? "void-mr-80" : ""}`}>
					{isLandingPage ?
          landingPageContent :
          threadPageContent}
				</div>
				...
				{showPromptHistory &&
        <div className="void-absolute void-top-0 void-right-0 void-bottom-0 void-w-80 void-border-l void-border-void-border-3 void-bg-void-bg-2 void-z-50 void-shadow-lg">
						<div className="void-h-full void-p-4">
							<ErrorBoundary>
								<PromptHistoryPanel
