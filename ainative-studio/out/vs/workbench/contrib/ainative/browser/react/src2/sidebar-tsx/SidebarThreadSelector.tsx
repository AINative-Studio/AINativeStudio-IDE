...
export const PastThreadsList = ({ className = '' }: {className?: string;}) => {
  ...
  return (
    <div className={`ainative-flex ainative-flex-col ainative-mb-2 ainative-gap-2 ainative-w-full ainative-text-nowrap ainative-text-void-fg-3 ainative-select-none ainative-relative ${className}`}>
      ...
      <div
        className="ainative-text-void-fg-3 ainative-opacity-80 hover:ainative-opacity-100 hover:ainative-brightness-115 ainative-cursor-pointer ainative-p-1 ainative-text-xs"
    ...
    onMouseLeave={() => setHoveredIdx(null)}>
		...
		<div className="ainative-flex ainative-items-center ainative-justify-between ainative-gap-1">
			<span className="ainative-flex ainative-items-center ainative-gap-2 ainative-min-w-0 ainative-overflow-hidden">
				{/* spinner */}
				{isRunning === 'LLM' || isRunning === 'tool' || isRunning === 'idle' ? <LoaderCircle className="ainative-animate-spin ainative-bg-void-stroke-1 ainative-flex-shrink-0 ainative-flex-grow-0" size={14} /> :

        isRunning === 'awaiting_user' ? <MessageCircleQuestion className="ainative-bg-void-stroke-1 ainative-flex-shrink-0 ainative-flex-grow-0" size={14} /> :
