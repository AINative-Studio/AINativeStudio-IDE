...
export const ToolLogsPanel: React.FC<ToolLogsPanelProps> = ({
	...
	return (
		<div className="tool-logs-panel" style={{ height }}>
			<div className="tool-logs-header">
				<h2>Tool Execution Logs</h2>
				<div className="tool-logs-actions">
					<button
						className="tool-logs-action-btn"
					...
					<button
						className={`tool-logs-action-btn ${autoRefresh ? 'active' : ''}`}
			...
			{error && (
				<div className="tool-logs-error">
					<span className="codicon codicon-error"></span>
					<span>{error}</span>
				</div>
			)}

			<div className="tool-logs-content">
				<div className="tool-logs-table-container">
					<ToolLogsTable
						data={logsData}
				...
				{selectedLog && (
					<div className="tool-logs-details-container">
						<ToolLogDetails
							log={selectedLog}
