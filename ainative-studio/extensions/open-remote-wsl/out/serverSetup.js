...
async function installCodeServer(wslManager, distroName, serverDownloadUrlTemplate, extensionIds, envVariables, logger) {
...
function generateBashInstallScript({ id, quality, version, commit, release, extensionIds, envVariables, serverApplicationName, serverDataFolderName, serverDownloadUrlTemplate }) {
